...
public class ArrayHeap<T> implements ExtrinsicPQ<T> {
    ...
    private void sink(int index) {
        ...
        validateSinkSwimArg(index);
        /** TODO: Your code here. */
        boolean left_flag = inBounds(index * 2);
        boolean right_flag = inBounds(index * 2 + 1);
    ...
    public void testSwim() {
        ...
        pq.size = 7;
        for (int i = 1; i <= 7; i += 1) {
            pq.contents[i] = (ArrayHeap<String>.Node) new Node((T) ("x" + i), i);
        }
