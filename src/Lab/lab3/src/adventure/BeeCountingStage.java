...
//        this.responses = Map.of("go", new SpeciesListStage(in));
    ...
    public void playStage() {
        while (true) {
            String msg = (" In Soda 326, you can find the computers known as " +
                          "The Hive" +
                          "It is a little - known fact that they are call" +
                          "ed this because they are home to(friendly) robotic bees." +
